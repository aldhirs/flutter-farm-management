...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
    ...
    AutoRoute(page: ChangePasswordRoute.page, guards: [authGuard()]),
    AutoRoute(page: DraftingScanRoute.page, guards: [authGuard()]),
    AutoRoute(page: DraftingListRoute.page, guards: [authGuard()]),
    ...
    AutoRoute(page: CattleTreatmentRoute.page, guards: [authGuard()]),
