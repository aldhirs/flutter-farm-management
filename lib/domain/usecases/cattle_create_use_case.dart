...
@Injectable()
class CattleCreateUseCase
    extends BaseFutureUseCase<CattleFormRequest, CattleOutput> {
  const CattleCreateUseCase(this._repository);

  final Repository _repository;

  @protected
  @override
  Future<CattleOutput> buildUseCase(CattleFormRequest input) async {
    final response = await _repository.cattleCreate(input);
